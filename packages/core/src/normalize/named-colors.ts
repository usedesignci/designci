/**
 * The CSS named colors, as 24-bit RGB integers.
 *
 * A lookup table rather than a heuristic: `rebeccapurple` is exactly #663399 or
 * it is not a named color at all. Generated from CSS Color Module Level 4.
 */
